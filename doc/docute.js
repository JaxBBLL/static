      ...
      (function (e, n) {
        ...
        function Oe(e, t) {
          ...
          if (c(e) && !(e instanceof ge))
            return (
              k(e, "__ob__") && e.__ob__ instanceof Se
                ? (n = e.__ob__)
                : Ae &&
                  !ae() &&
                  (Array.isArray(e) || l(e)) &&
        ...
        function Ie(e, t) {
          if (!t) return e;
          for (
            var n, r, i, o = le ? Reflect.ownKeys(t) : Object.keys(t), a = 0;
            a < o.length;
            a++
          )
            "__ob__" !== (n = o[a]) &&
              ((r = e[n]),
              (i = t[n]),
              k(e, n) ? r !== i && l(r) && l(i) && Ie(r, i) : Te(e, n, i));
          return e;
        }
        function Fe(e, t, n) {
          return n
        ...
        (je.data = function (e, t, n) {
          ...
          (je.props = je.methods = je.inject = je.computed = function (
            e,
            t,
            n,
            r
                  ...
                  i((u = t[c])) ||
                    ...
                    Array.isArray(u)
                      ? u.length > 0 &&
                        (pt((u = e(u, (n || "") + "_" + c))[0]) &&
                          pt(f) &&
                          ((r[l] = _e(f.text + u[0].text)), u.shift()),
                        r.push.apply(r, u))
                      : s(u)
                      ? pt(f)
                        ? (r[l] = _e(f.text + u))
        ...
        function Ft(e, t, n, i, o) {
          ...
          (this.data = e),
            ...
            (this.slots = function () {
              return (
                c.$slots || mt(e.scopedSlots, (c.$slots = ht(n, i))), c.$slots
              );
            }),
              ...
              if (a(e.options.functional))
                return (function (e, t, n, i, a) {
                  var s = e.options,
                    c = {},
                    u = s.props;
                  if (o(u)) for (var l in u) c[l] = De(l, u, t || r);
                  else
                    o(n.attrs) && Rt(c, n.attrs), o(n.props) && Rt(c, n.props);
                  var f = new Ft(n, c, a, i, e),
                    p = s.render.call(null, f._c, f);
                  if (p instanceof ge) return Mt(p, n, f.parent, s, f);
                  if (Array.isArray(p)) {
                    for (
                      var d = ft(p) || [], h = new Array(d.length), v = 0;
                      v < d.length;
                      v++
                    )
                      h[v] = Mt(d[v], n, f.parent, s, f);
                    return h;
                  }
                })(e, p, t, n, s);
              var h = t.on;
              ...
              if ("string" === typeof t) {
                ...
                (l = (e.$vnode && e.$vnode.ns) || H.getTagNamespace(t)),
                  (u = H.isReservedTag(t)
                    ...
                    : (n && n.pre) || !o((f = ze(e.$options, "components", t)))
          ...
          (mn.prototype.update = function () {
            this.lazy
              ...
              : (function (e) {
                  ...
                  if (null == sn[t]) {
                    if (((sn[t] = !0), un)) {
                      for (var n = on.length - 1; n > ln && on[n].id > e.id; )
                        n--;
                      on.splice(n + 1, 0, e);
                    } else on.push(e);
                    cn || ((cn = !0), rt(hn));
        ...
        function kn(e, t, n) {
          var r = !ae();
          "function" === typeof n
            ? ((gn.get = r ? wn(t) : xn(n)), (gn.set = j))
            : ((gn.get = n.get ? (r && !1 !== n.cache ? wn(t) : xn(n.get)) : j),
              (gn.set = n.set || j)),
          ...
          e.prototype._init = function (e) {
            ...
            (t._uid = An++),
              ...
              e && e._isComponent
                ...
                : (t.$options = Ne($n(t.constructor), e || {}, t)),
              (t._renderProxy = t),
              (t._self = t),
              (function (e) {
                var t = e.$options,
        ...
        !(function (e) {
          ...
          Object.defineProperty(Sn.prototype, "$isServer", { get: ae }),
        ...
        function hr(e, t) {
          ...
          for (n = 0; n < e.length; n++)
            (r = e[n]).modifiers || (r.modifiers = dr),
              (i[vr(r)] = r),
              (r.def = ze(t.$options, "directives", r.name));
          return i;
        }
        function vr(e) {
          return (
          ...
          (i = i || r).right
            ...
            : i.middle &&
              (c
                ? (t = "(" + t + ")==='click'?'mouseup':(" + t + ")")
                : "click" === t && (t = "mouseup")),
            i.capture && (delete i.capture, (t = zr("!", t, c))),
            i.once && (delete i.once, (t = zr("~", t, c))),
            i.passive && (delete i.passive, (t = zr("&", t, c))),
            i.native
        ...
        function qr(e, t) {
          var n = (function (e) {
            if (
              ((e = e.trim()),
              (xr = e.length),
              e.indexOf("[") < 0 || e.lastIndexOf("]") < xr - 1)
            )
          ...
          if (!i(e.data.on) || !i(t.data.on)) {
            ...
            (Xr = t.elm),
              (function (e) {
                ...
                o(e[ei]) &&
                  ((e.change = [].concat(e[ei], e.change || [])), delete e[ei]);
              })(n),
          ...
          if (!i(e.data.domProps) || !i(t.data.domProps)) {
            ...
            for (n in c) {
              ...
              if ("value" === n && "PROGRESS" !== a.tagName) {
                ...
                (ai = ai || document.createElement("div")).innerHTML =
                  "<svg>" + r + "</svg>";
        ...
        var hi,
          ...
          gi = function (e, t, n) {
            if (vi.test(t)) e.style.setProperty(t, n);
              ...
              e.style.setProperty(S(t), n.replace(mi, ""), "important");
            else {
              var r = bi(t);
              if (Array.isArray(n))
        ...
        Si &&
          (void 0 === window.ontransitionend &&
            ...
            ((Ti = "WebkitTransition"), (Li = "webkitTransitionEnd")),
        ...
        function Di(e, t) {
          ...
          return (
            t === Oi
              ...
              : t === Ei
              ? u > 0 && ((n = Ei), (l = u), (f = c.length))
              : (f = (n = (l = Math.max(a, u)) > 0 ? (a > u ? Oi : Ei) : null)
                  ? n === Oi
                    ? o.length
                    : c.length
                  : 0),
            ...
            if (!S || k || "" === k) {
              ...
              var R = !1 !== a && !Q,
                ...
                z = (n._enterCb = P(function () {
                  R && (Pi(n, T), Pi(n, E)),
                    z.cancelled ? (R && Pi(n, O), F && F(n)) : I && I(n),
                    (n._enterCb = null);
                }));
              e.data.show ||
                ...
                R &&
                  ...
                  Mi(function () {
                    Pi(n, O),
                      z.cancelled ||
                        (Ri(n, T),
                        N || (Zi(M) ? setTimeout(z, M) : Ni(n, s, z)));
                  })),
                e.data.show && (t && t(), j && j(n, z)),
                R || N || z();
            }
          }
        }
          ...
          if (!o(n._leaveCb)) {
            ...
            var w = (n._leaveCb = P(function () {
              n.parentNode &&
                ...
                b && (Pi(n, l), Pi(n, f)),
                w.cancelled ? (b && Pi(n, u), m && m(n)) : (t(), h && h(n)),
                (n._leaveCb = null);
            }));
            g ? g(x) : x();
          }
            ...
            w.cancelled ||
              ...
              b &&
                ...
                Mi(function () {
                  Pi(n, u),
                    w.cancelled ||
                      (Ri(n, l), _ || (Zi(k) ? setTimeout(w, k) : Ni(n, s, w)));
                })),
              d && d(n, w),
              b || _ || w());
          }
                        ...
                        for (0; p <= h && d <= g; )
                          i(v)
                            ...
                            : (i(s) && (s = lr(t, p, h)),
                              ...
                              (y = n[++d]));
                        p > h
                          ? b(e, i(n[g + 1]) ? null : n[g + 1].elm, n, d, g, r)
                          : d > g && k(0, t, p, h);
                      })(p, m, g, n, l)
                    : o(g)
        ...
        function Yi(e, t, n) {
          ...
          if (!i || Array.isArray(r)) {
            for (var o, a, s = 0, c = e.options.length; s < c; s++)
              if (((a = e.options[s]), i))
                (o = R(r, Qi(a)) > -1), a.selected !== o && (a.selected = o);
              else if (M(Qi(a), r))
        ...
        (Sn.config.mustUseProp = Pn),
          ...
          T(Sn.options.directives, io),
          T(Sn.options.components, go),
          (Sn.prototype.__patch__ = K ? Ki : j),
        ...
        var wo,
          ...
          Co = function (e) {
            return (
              ((wo = wo || document.createElement("div")).innerHTML = e),
              wo.textContent
            );
          },
          Ao = m(
        ...
        function va(e, t) {
          (qo = t.warn || Ir),
            (Yo = t.isPreTag || I),
            (Xo = t.mustUseProp || I),
            (Qo = t.getTagNamespace || I);
          var n = t.isReservedTag || I;
          (function (e) {
            return !!e.component || !n(e.tag);
          },
            (Ko = Fr(t.modules, "transformNode")),
            (Jo = Fr(t.modules, "preTransformNode")),
            (Wo = Fr(t.modules, "postTransformNode")),
            (Vo = t.delimiters));
          var r,
            i,
            o = [],
            ...
            (function (e, t) {
              ...
              function C() {
                ...
                if (t) {
                  ...
                  for (
                    x(t[0].length);
                    !(n = e.match(Io)) && (r = e.match(Eo) || e.match(Oo));
            ...
            (function (e) {
              ...
              for (t = 0, n = u.length; t < n; t++) {
                if (((r = i = u[t].name), (o = u[t].value), ta.test(r)))
                  if (
                    ((e.hasBindings = !0),
                    (a = _a(r.replace(ta, ""))) && (r = r.replace(ca, "")),
                    sa.test(r))
                  )
                    (r = r.replace(sa, "")),
                      (o = Lr(o)),
                      ...
                      a &&
                        ...
                        a.sync &&
                          ...
                          c
                            ...
                            : (Dr(e, "update:" + C(r), s, null, !1, 0, u[t]),
                              S(r) !== C(r) &&
                                Dr(
                                  e,
                                  "update:" + S(r),
        ...
        var Ha = {
          ...
          Ba = function (e) {
            (this.options = e),
              ...
              (this.directives = T(T({}, Ha), e.directives));
        ...
        function Ya(e, t) {
          ...
          var r = e.slotScope === da ? "" : String(e.slotScope),
            i =
              ...
              ("template" === e.tag
                ? e.if && n
                  ? "(" + e.if + ")?" + (Xa(e, t) || "undefined") + ":undefined"
                  : Xa(e, t) || "undefined"
                : Ua(e, t)) +
              "}",
            o = r ? "" : ",proxy:true";
        ...
        function es(e, t) {
          return 1 === e.type
            ...
            : (function (e) {
                return (
                  "_v(" +
                  (2 === e.type ? e.expression : ns(JSON.stringify(e.text))) +
                  ")"
                );
              })(e);
        }
          ...
          var t = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            r = {
              ...
              highlightAllUnder: function (e, t, n) {
                ...
                for (
                  var o, a = e.querySelectorAll(i.selector), s = 0;
                  (o = a[s++]);
              ...
              highlightElement: function (n, i, o) {
                for (var a, s = "none", c = n; c && !t.test(c.className); )
                  c = c.parentNode;
                c &&
                  ((s = (c.className.match(t) || [, "none"])[1].toLowerCase()),
                  (a = r.languages[s])),
                  (n.className =
                      ...
                      for (
                        ...
                        if (!(k instanceof i)) {
                          if (v && b != t.length - 1) {
                            ...
                            for (
                              var w = S.index + (h ? S[1].length : 0),
                                x = S.index + S[0].length,
                                C = b,
                                A = _,
                                $ = t.length;
                              C < $ &&
                              (A < x || (!t[C].type && !t[C - 1].greedy));
                              ++C
                            )
                              w >= (A += t[C].length) && (++b, (_ = A));
                          ...
                          if (S) {
                            ...
                            if (
                              ...
                              1 != O && r.matchGrammar(e, t, n, b, _, !0, u),
                              s)
                            )
                              break;
                          } else if (s) break;
                  ...
                  e.addEventListener(
                    ...
                    function (t) {
                      var n = JSON.parse(t.data),
                        ...
                        o = n.code,
                        a = n.immediateClose;
                      e.postMessage(r.highlight(o, r.languages[i], i)),
                        a && e.close();
                    },
                    !1
                  ),
        ...
        var o,
          ...
          c = t.afterEach(function (t, n) {
            a
              ? (a = !1)
              : ((o = t.fullPath),
                e.commit(i + "/ROUTE_CHANGED", { to: t, from: n }));
          });
        return function () {
            ...
            d = function () {
              ...
              if (
                ...
                e.container &&
                  ...
                  (t.container = r({}, O.container, e.container)),
                e.template)
              ) {
                var n = o(e.template)
                  ? e.template
              ...
              return (
                ...
                C.forEach(function (e) {
                  e.dispatchEvent(
                    l("medium-zoom:update", { detail: { zoom: L } })
                  );
                }),
                L
              );
              ...
              return (
                r.forEach(function (e) {
                  e.classList.remove("medium-zoom-image"),
                    e.dispatchEvent(
                      l("medium-zoom:detach", { detail: { zoom: L } })
                    );
                }),
                ...
                n = function () {
                  ...
                  var p = E.zoomedHd || E.original,
                    ...
                    x =
                      ...
                      w +
                      ") translate3d(" +
                      ((n - y) / 2 - g + O.margin + t.left) / w +
                      "px, " +
                      ((i - b) / 2 - m + O.margin + t.top) / w +
                      "px, 0)";
                  (E.zoomed.style.transform = x),
                    E.zoomedHd && (E.zoomedHd.style.transform = x);
                };
                ...
                if (t && -1 === C.indexOf(t)) e(L);
                  ...
                  if (
                    (E.original.dispatchEvent(
                      l("medium-zoom:open", { detail: { zoom: L } })
                    ),
                    (S =
                      window.pageYOffset ||
                      document.documentElement.scrollTop ||
                    ...
                    (E.template = document.createElement("div")),
                      E.template.appendChild(i.content.cloneNode(!0)),
                  ...
                  if (
                    ...
                    var a = setInterval(function () {
                      E.zoomedHd.complete &&
                        ...
                        E.zoomedHd.addEventListener("click", _),
                    ...
                    var s = E.zoomedHd.addEventListener("load", function () {
                      E.zoomedHd.removeEventListener("load", s),
                        E.zoomedHd.classList.add("medium-zoom-image--opened"),
                        E.zoomedHd.addEventListener("click", _),
                        document.body.appendChild(E.zoomedHd),
                        n();
              ...
              return new i(function (e) {
                !$ && E.original
                  ? (($ = !0),
                    ...
                    E.original.dispatchEvent(
                      l("medium-zoom:close", { detail: { zoom: L } })
                    ),
                    E.zoomed.addEventListener("transitionend", function t() {
                      E.original.classList.remove("medium-zoom-image--hidden"),
                        ...
                        E.zoomed.removeEventListener("transitionend", t),
                        E.original.dispatchEvent(
                          l("medium-zoom:closed", { detail: { zoom: L } })
                        ),
                        (E.original = null),
                        (E.zoomed = null),
                        (E.zoomedHd = null),
    ...
    function (e, t, n) {
      ...
      function c(e, t, n) {
        if (!e.s) {
          ...
          if (n && n.then)
            return void n.then(c.bind(null, e, t), c.bind(null, e, 2));
          (e.s = t), (e.v = n);
          var r = e.o;
          r && r(e);
        }
      ...
      (b._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/),
        ...
        (b.bullet = /(?:[*+-]|\d+\.)/),
        (b.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/),
        (b.item = O(b.item, "gm").replace(/bull/g, b.bullet).getRegex()),
        (b.list = O(b.list)
        ...
        (b.html = O(b.html, "i")
          ...
          .getRegex()),
        (b.paragraph = O(b.paragraph)
          .replace("hr", b.hr)
          .replace("heading", b.heading)
          .replace("lheading", b.lheading)
          .replace("tag", b._tag)
          .getRegex()),
        (b.blockquote = O(b.blockquote)
        ...
        (_.prototype.token = function (e, t) {
          ...
          for (e = e.replace(/^ +$/gm, ""); e; )
            if (
              ...
              for (e = e.substring(i[0].length), p = 0; p < s.align.length; p++)
                /^ *-+: *$/.test(s.align[p])
                  ? (s.align[p] = "right")
                  : /^ *:-+: *$/.test(s.align[p])
                  ? (s.align[p] = "center")
              ...
              for (p = 0; p < s.cells.length; p++)
                s.cells[p] = F(s.cells[p], s.header.length);
              this.tokens.push(s);
              ...
              for (
                e = e.substring(i[0].length),
                  ...
                  u = [],
                  n = !1,
                  h = (i = i[0].match(this.rules.item)).length,
                  p = 0;
                p < h;
                p++
              )
                (f = (s = i[p]).length),
                  ~(s = s.replace(/^ *([*+-]|\d+\.) +/, "")).indexOf("\n ") &&
                    ...
                    (s = this.options.pedantic
                      ? s.replace(/^ {1,4}/gm, "")
                      : s.replace(new RegExp("^ {1," + f + "}", "gm"), ""))),
                  this.options.smartLists &&
                    p !== h - 1 &&
                    (o === (a = b.bullet.exec(i[p + 1])[0]) ||
      ...
      function w(e, t) {
        if (
          ...
          (this.links = e),
          (this.rules = k.normal),
          (this.renderer = this.options.renderer || new x()),
      ...
      function $(e, t) {
        if (t) {
          if ($.escapeTest.test(e))
            return e.replace($.escapeReplace, function (e) {
              return $.replacements[e];
            });
        } else if ($.escapeTestNoEncode.test(e))
          return e.replace($.escapeReplaceNoEncode, function (e) {
            return $.replacements[e];
          });
        return e;
      }
      ...
      (k._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
        ...
        (k.tag = O(k.tag)
          ...
          .getRegex()),
        (k._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/),
        (k._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f\\]*\)|[^\s\x00-\x1f()\\])*?)/),
        (k._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
        (k.link = O(k.link)
          ...
          .getRegex()),
        (k.reflink = O(k.reflink).replace("label", k._label).getRegex()),
        (k.normal = I({}, k)),
        (k.pedantic = I({}, k.normal, {
          ...
          for (var t, n, r, i, o, a, s = ""; e; )
            if ((o = this.rules.escape.exec(e)))
              ...
              if ((o = this.rules.tag.exec(e)))
                ...
                (e = e.substring(o[0].length)),
                  (s += this.renderer.codespan($(o[2].trim(), !0)));
                ...
                (e = e.substring(o[0].length)),
                  this.inRawBlock
                    ? (s += this.renderer.text(o[0]))
                    : (s += this.renderer.text($(this.smartypants(o[0]))));
              else if (e)
                throw new Error("Infinite loop on byte: " + e.charCodeAt(0));
            } else {
        ...
        (C.prototype.strong = C.prototype.em = C.prototype.codespan = C.prototype.del = C.prototype.text = function (
          e
        ) {
          return e;
        }),
        ...
        (A.prototype.parse = function (e) {
          (this.inline = new w(e.links, this.options)),
            (this.inlineText = new w(
              e.links,
              I({}, this.options, { renderer: new C() })
            )),
        ...
        (A.prototype.tok = function () {
          switch (this.token.type) {
            ...
            case "list_start":
              o = "";
              for (
                var a = this.token.ordered, s = this.token.start, c = !1;
                "list_end" !== this.next().type;

              )
                this.token.task && (c = !0), (o += this.tok());
            ...
            case "list_item_start":
              ...
              var u = this.token.loose,
                l = this.token.task;
              for (
                l && (o += this.renderer.checkbox(this.token.checked));
      ...
      function D(e, t) {
        ...
        return (
          n || ((t = "markup"), (n = z.a.languages.markup)),
          z.a.highlight(e, n, t)
        );
      }
      var H = function (e) {
        ...
        Z = function (e) {
          ...
          return (
            (t.code = function (e, t, n, i) {
              ...
              if (
                (i.interpolate || (a = a.replace(/^<pre>/, "<pre v-pre>")),
                i.highlight)
              ) {
                var s = e
                  .split("\n")
          ...
          actions: {
            fetchFile: function (e, t) {
              ...
              try {
                ...
                if (!o.content && !o.file) {
                  var a = G(t);
                  (o.file = B(r.config.sourcePath, a)),
                    (o.editLink =
                      r.config.editLinkBase && B(r.config.editLinkBase, a));
                }
                return Y(
                  Promise.all([
                    !o.content &&
                      fetch(o.file, r.config.fetchOptions)
                        .then(function (e) {
                          return e.text();
                        })
                        .then(function (e) {
                  ...
                  function () {
                    return Y(
                      f.processPromise("processMarkdown", o.content),
                      function (e) {
                        return (
                          (o.content = e),
                          Y(f.processPromise("processPage", o), function (e) {
                            o = e;
                            var t = {
                              headings: [],
                              mixins: [],
                            ...
                            return (
                              o.markdown &&
                                (o.content = P(o.content, {
                                  renderer: Z(f),
                                  highlight: D,
                                  env: t,
                                })),
                              Y(
                                f.processPromise("processHTML", o.content),
                                function (e) {
                                  (o.content = e),
                                    (o.headings = t.headings),
          ...
          getters: {
            ...
            currentLocalePath: function (e, t) {
              ...
              if (r)
                for (var i = 0, o = Object.keys(r); i < o.length; i++) {
                  var a = o[i];
                  if ("/" !== a) if (new RegExp("^" + a).test(n.path)) return a;
                }
              return "/";
            },
            config: function (e, t) {
            ...
            cssVariables: function (e, t) {
              ...
              return Object.assign(
                ...
                "dark" === n.theme ? W : J,
                {},
                "function" === typeof n.cssVariables
      ...
      var ie = {
        ...
        render: function (e, t) {
          ...
          for (
            ...
            p && (p.routerView && l++, p.keepAlive && i._inactive && (f = !0)),
              (i = i.$parent);
          }
      ...
      function ye(e, t) {
        return t === ve
          ...
          : !!t &&
              (e.path && t.path
                ? e.path.replace(pe, "") === t.path.replace(pe, "") &&
                  e.hash === t.hash &&
                  be(e.query, t.query)
                : !(!e.name || !t.name) &&
                  e.name === t.name &&
      ...
      function Le(e) {
        ...
        return function (n, r) {
          for (
            var i = "",
              o = n || {},
              a = (r || {}).pretty ? Te : encodeURIComponent,
              s = 0;
            s < e.length;
            s++
          ) {
      ...
      (xe.parse = Ce),
        (xe.compile = Ae),
        (xe.tokensToFunction = $e),
        (xe.tokensToRegExp = Se);
        ...
        Ze = {
          ...
          render: function (e) {
            var t = this,
              ...
              v = a.redirectedFrom
                ? de(null, De(a.redirectedFrom), null, n)
                : a;
            (c[h] = ye(r, v)),
              (c[d] = this.exact
                ? c[h]
      ...
      function We(e, t) {
        ...
        function s(e, n) {
          ...
          if (l) {
            ...
            return a(
              { _normalized: !0, path: ze(h, d), query: f, hash: p },
              void 0,
              n
            );
          }
      ...
      var Xe =
        Ve && window.performance && window.performance.now
          ? window.performance
          : Date;
      function Qe() {
      ...
      function it() {
        ...
        window.history.replaceState({ key: tt() }, "", t),
      ...
      function dt(e, t) {
        ...
        try {
          t
            ? n.replaceState({ key: tt() }, "", e)
            : n.pushState({ key: nt(Qe()) }, "", e);
        } catch (r) {
              ...
              var c,
                u = _t(function (t) {
                  ...
                  ((i = t).__esModule ||
                    ...
                    (t = t.default),
                    (e.resolved = "function" === typeof t ? t : He.extend(t)),
                    (n.components[s] = t),
                    --o <= 0 && r();
                }),
                l = _t(function (e) {
      ...
      (wt.prototype.listen = function (e) {
        ...
        (wt.prototype.confirmTransition = function (e, t, n) {
          ...
          if (ye(e, i) && e.matched.length === i.matched.length)
            return this.ensureURL(), o(new kt(e));
          var a = (function (e, t) {
              var n,
          ...
          e.call(this, t, n),
            (r &&
              (function (e) {
                var t = $t(e);
                if (!/^\/#/.test(t))
                  return window.location.replace(ke(e + "/#" + t)), !0;
              })(this.base)) ||
              Ot();
        }
        return (
      ...
      var It = (function (e) {
        ...
        Ft = function (e) {
          void 0 === e && (e = {}),
            ...
            (this.resolveHooks = []),
            (this.afterHooks = []),
            (this.matcher = We(e.routes || [], this));
          var t = e.mode || "hash";
          switch (
            ((this.fallback = "history" === t && !pt && !1 !== e.fallback),
      ...
      (Ft.prototype.match = function (e, t, n) {
        ...
        (Ft.install = function e(t) {
          if (!e.installed || He !== t) {
            ...
            t.mixin({
              ...
              t.component("RouterView", ie),
              t.component("RouterLink", Ze);
        ...
        (Ft.version = "3.1.3"),
        Ve && window.Vue && window.Vue.use(Ft);
      var Pt = Ft,
        ...
        Dt =
          Nt &&
          (!zt ||
            (-1 === (zt.effectiveType || "").indexOf("2g") && !zt.saveData)),
      ...
      function Ut(e) {
        return self.fetch ? fetch(e, { credentials: "include" }) : Gt(e);
      }
      var Zt = (function (e) {
        if (Nt) {
      ...
      function qt(e, t) {
        if (Dt && !Bt[e])
          return (t ? Ut : Zt)(e).then(function () {
            Bt[e] = !0;
          });
      }
      var Vt = function (e, t) {
          ...
          var i =
            ...
            a = {
              ...
              props: {
                prefetch: { type: Boolean, default: r },
              ...
              mounted: function () {
                this.prefetch &&
                  i &&
                  Dt &&
                  o(this.observe, { timeout: this.timeout });
              },
              ...
              methods: {
                ...
                linkPrefetch: function () {
                  ...
                  if (!e.meta.__prefetched) {
                    ...
                    var i = (this.prefetchFiles || []).concat(
        ...
        Wt = (function () {
              ...
              u < s
                ...
                : (function () {
                    window.scrollTo(0, t + a),
                      e && o && (e.setAttribute("tabindex", "-1"), e.focus());
                    "function" === typeof f && f();
                    c = !1;
                  })();
          }
          return function (c) {
            ...
            switch (
              ...
              "undefined" === typeof c ? "undefined" : Jt(c))
            ) {
              case "number":
                (e = void 0), (o = !1), (n = t + c);
                break;
        ...
        rn = {
          components: { UniLink: nn },
          props: { nav: { type: Array, required: !0 } },
          methods: { isExternalLink: H },
        },
        on =
          (n(38),
          h(
                                  ...
                                  n(
                                    "uni-link",
                                    {
                                      ...
                                      attrs: {
                                        to: t.link,
                                        openInNewTab: t.openInNewTab,
                                        prefetchFiles: e.getPrefetchFiles(
                                          t.link
                                        ),
                                      },
                                    },
            ...
            methods: {
              openItem: function (e) {
                this.closedItems.indexOf(e) > -1 &&
                  (this.closedItems = this.closedItems.filter(function (t) {
                    return t !== e;
                  }));
              },
              toggleItem: function (e) {
                -1 === this.closedItems.indexOf(e)
              ...
              getCurrentIndex: function (e, t) {
                for (var n = 0; n < t.length; n++)
                  if (
                    this.getChildren(t[n]).some(function (t) {
                      return t.link === e;
                    })
                  )
                    return n;
        ...
        hn = {
          computed: Object.assign({}, Object(m.b)(["sidebarLinks"]), {
            ...
            prevLinkItem: function () {
              return "number" === typeof this.currentLinkIndex
        ...
        mn = {
          computed: {
            ...
            editLinkText: function () {
              return (
                this.$store.getters.config.editLinkText || "Edit this page"
              );
            },
          },
        },
            ...
            function () {
              ...
              return this.editLink
                ? t("div", { staticClass: "EditLink" }, [
                    t(
                      "a",
                      { attrs: { target: "_blank", href: "" + this.editLink } },
                      [
                        t(
                          "svg",
                          {
            ...
            fetchFile: function (e) {
              try {
                ...
                return yn(t.$store.dispatch("fetchFile", e), function () {
                  return (
                    f.invoke("onContentWillUpdate", t),
                    yn(t.$nextTick(), function () {
      ...
      var kn = function (e) {
            ...
            [
              function (e, t) {
                ...
                return n("div", { staticClass: "loading" }, [
                  ...
                  t._v(" "),
                  n("span", { staticClass: "loading-text" }, [
                    t._v("Loading Gist"),
                  ]),
                ]);
              },
        ...
        Nn = {
          name: "i18n",
          extend: function (e) {
            e.store.getters.languageOverrides &&
              e.registerComponent("sidebar:start", Pn);
          },
        },
        zn = {
          name: "hoistTags",
        ...
        Dn = {
          ...
          computed: {
            currentVersionLink: function () {
              for (
                var e = this.$store.getters.config.versions,
                  t = 0,
                  n = Object.keys(e);
                t < n.length;
                t++
        ...
        Bn = {
          ...
          extend: function (e) {
            e.store.getters.config.versions &&
              e.registerComponent("sidebar:start", Hn);
          },
        },
        Gn = function (e, t) {
        ...
        Un = {
          ...
          extend: function (e) {
            var t = e.store.getters.config,
              n = t.banner,
              r = t.footer;
            n && e.registerComponent("content:start", Gn(n, "docute-banner")),
              r && e.registerComponent("content:end", Gn(r, "docute-footer"));
          },
        },
        Zn = {
          data: function () {
            ...
            return {
              dark:
                ...
                "dark" === e ||
                ("default" !== e &&
                  "dark" === this.$store.getters.config.theme),
            };
          },
          created: function () {
          ...
          methods: {
            handleChange: function () {
              ...
              (this.dark = !this.dark),
                this.$store.commit(
                  "SET_THEME",
                  this.dark ? "dark" : "dark" === e ? "default" : e
                ),
        ...
        Vn = {
          ...
          extend: function (e) {
            ...
            !0 === t
              ? e.registerComponent("sidebar:post-end", qn)
              : "sidebar" === t &&
                (e.registerComponent("header-right:start", qn),
                e.registerComponent("mobile-sidebar:start", qn));
          },
        };
      function Kn(e, t, n, r) {
        var i,
      ...
      r.a.component(Cn.name, Cn),
        r.a.component($n.name, $n),
        r.a.component(On.name, On),
        r.a.component(Tn.name, Tn),
        r.a.component(Mn.name, Mn),
        r.a.component(jn.name, jn),
        r.a.component(Fn.name, Fn),
        r.a.use(function (e) {
          e.component("v-style", wn("style")),
            e.component("v-script", wn("script"));
        }),
        r.a.mixin({
          created: function () {
      ...
      var nr = (function () {
        function e(e) {
          ...
          Object(i.sync)(ee, t),
            ...
            ee.commit(
              "SET_CONFIG",
              Object.assign({ title: U && document.title }, e)
            );
          var n = [Nn, zn, Bn, Un, Vn, tr].concat(
            ee.state.originalConfig.plugins || []
          );
          (this.pluginApi = new p({ plugins: n, store: ee, router: t })),
            this.applyPlugins(),
            (this.app = new r.a({
              router: t,
              store: ee,
      ...
      t.default = nr;
      "undefined" !== typeof window &&
        ((window.Vue = r.a), (window.__DOCUTE_VERSION__ = "4.23.3"));
    },
  ]).default;
});
